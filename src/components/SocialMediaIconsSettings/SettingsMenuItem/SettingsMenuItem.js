...
const SettingsMenuItem = ({type, primaryText, secondaryText, onChangeComplete, adjustment,...others,}) => {
    var req = require.context("/home/pil0t/Projects/reactThings/projectAttempt2/src/components/SettingsComponents/Types", true, /^\.\/.*\.jsx?$/); //This is some webpack bs for when it compiles require statement with expressions.
